/*
 ...
 Nombre ERD: 
 */
-- PROCEDURE: nova_ticket.sp_set_subticket(character varying, character varying, integer, integer, integer, integer, character varying, integer, integer, integer, integer, integer, integer, integer)
-- DROP PROCEDURE IF EXISTS nova_ticket.sp_set_subticket(character varying, character varying, integer, integer, integer, integer, character varying, integer, integer, integer, integer, integer, integer, integer);
CREATE
OR REPLACE PROCEDURE nova_ticket.sp_set_subticket(
...
ALTER PROCEDURE nova_ticket.sp_set_subticket(
  character varying,
  character varying,
  integer,
  integer,

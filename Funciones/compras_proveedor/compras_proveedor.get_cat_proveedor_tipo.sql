...
CREATE
OR REPLACE FUNCTION compras_proveedor.get_cat_proveedor_tipo(
...
from
  compras_proveedor.tbl_cat_proveedor_tipo tcpt
  LEFT JOIN LATERAL (
    SELECT
...
ALTER FUNCTION compras_proveedor.get_cat_proveedor_tipo(character varying, integer, integer) OWNER TO vince;
...
ALTER FUNCTION recepciones_documento.get_documento_solicituddetalle(integer, bigint, character varying, integer, numeric, integer, character varying, integer, integer)
    OWNER TO vince;

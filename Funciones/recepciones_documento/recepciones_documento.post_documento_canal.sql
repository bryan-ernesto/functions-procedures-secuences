...
CREATE OR REPLACE FUNCTION recepciones_documento.post_documento_canal(
...
BEGIN
	RETURN QUERY
	INSERT INTO recepciones_documento.tbl_cat_documento_canal(
		nombre,
		descripcion,
		estado, 
		creado_por, 
...
ALTER FUNCTION recepciones_documento.post_documento_canal(character varying, character varying, integer)
    OWNER TO vince;

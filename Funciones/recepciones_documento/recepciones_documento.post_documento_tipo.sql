...
CREATE OR REPLACE FUNCTION recepciones_documento.post_documento_tipo(
...
BEGIN
	RETURN QUERY
	INSERT INTO recepciones_documento.tbl_cat_documento_tipo(
		nombre,
		descripcion,
		estado, 
		creado_por, 
...
ALTER FUNCTION recepciones_documento.post_documento_tipo(character varying, character varying, integer, integer)
    OWNER TO vince;

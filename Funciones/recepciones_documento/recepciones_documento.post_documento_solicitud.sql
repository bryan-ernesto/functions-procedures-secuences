/*
 ...
 Nombre ERD: NO
 */
-- FUNCTION: recepciones_documento.post_documento_solicitud(integer, integer, integer, integer, integer, integer, integer)

-- DROP FUNCTION IF EXISTS recepciones_documento.post_documento_solicitud(integer, integer, integer, integer, integer, integer, integer);

CREATE OR REPLACE FUNCTION recepciones_documento.post_documento_solicitud(
...
BEGIN
	RETURN QUERY
	INSERT INTO recepciones_documento.tbl_det_documento_recepcion_solicitud(
		individual_masiva, 
	...
	VALUES (
		int_individual_masiva, -- individualMasiva
		int_id_cat_documento_estado, -- idCatDocumentoEstado
		int_id_cat_documento_tipo, -- idCatDocumentoTipo
		int_id_cat_usuario_autorizador, -- idCatUsuarioAutorizador
...
ALTER FUNCTION recepciones_documento.post_documento_solicitud(integer, integer, integer, integer, integer, integer, integer)
    OWNER TO vince;

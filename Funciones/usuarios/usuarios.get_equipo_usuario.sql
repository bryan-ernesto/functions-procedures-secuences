/*
 ...
 Descripción: función que permite visualizar en que equipo se encuentra un usuario
 Dependencias: usuarios.tbl_det_usuario_asignacion_equipo, usuarios.tbl_cat_equipo, usuarios.tbl_cat_usuario
 ERD: NO
 Nombre ERD: NO
 */

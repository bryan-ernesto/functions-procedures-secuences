/*
 ...
 Descripción: función que obtiene la información de todos los departamentos o por departamento por medio del nombre enviado como parámetro
 Dependencias: usuarios.tbl_cat_departamento, usuarios.tbl_cat_empresa
 ERD: NO
 Nombre ERD: NO
 */

/*
 ...
 Descripción: secuencia que incrementa de uno en uno el id_bit_marcaje de la tabla tbl_bit_marcaje, cada vez que se ingrese un registro o se ejecute una función o procedimiento
 Dependencias: tbl_bit_marcaje
 ERD: NO
 Nombre ERD: NO
 */

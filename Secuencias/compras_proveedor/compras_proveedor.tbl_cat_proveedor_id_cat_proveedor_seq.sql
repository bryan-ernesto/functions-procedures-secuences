/*
 ...
 Descripción: secuencia que incrementa de uno en uno el id_cat_proveedor de la tabla tbl_cat_proveedor, cada vez que se ingrese un registro o se ejecute una función o procedimiento
 Dependencias: tbl_cat_proveedor
 ERD: NO
 Nombre ERD: NO
 */

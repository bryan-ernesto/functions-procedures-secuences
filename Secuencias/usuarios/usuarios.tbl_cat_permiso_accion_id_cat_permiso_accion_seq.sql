/*
 ...
 Descripción: secuencia que incrementa de uno en uno el id_cat_permiso_accion de la tabla tbl_cat_permiso_accion, cada vez que se ingrese un registro o se ejecute una función o procedimiento
 Dependencias: tbl_cat_permiso_accion
 ERD: NO
 Nombre ERD: NO
 */

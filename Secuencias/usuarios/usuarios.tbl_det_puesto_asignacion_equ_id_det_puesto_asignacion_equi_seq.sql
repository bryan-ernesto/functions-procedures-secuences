/*
 ...
 Descripción: secuencia que incrementa de uno en uno el id_det_puesto_asignacion_equipo de la tabla tbl_det_puesto_asignacion_equipo, cada vez que se ingrese un registro o se ejecute una función o procedimiento
 Dependencias: tbl_det_puesto_asignacion_equipo
 ERD: NO
 Nombre ERD: NO
 */

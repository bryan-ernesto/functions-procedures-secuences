/*
 ...
 Descripción: secuencia que incrementa de uno en uno el id_det_equipo_asignacion_resp de la tabla tbl_det_equipo_asignacion_res, cada vez que se ingrese un registro o se ejecute una función o procedimiento
 Dependencias: tbl_det_equipo_asignacion_res
 ERD: NO
 Nombre ERD: NO
 */

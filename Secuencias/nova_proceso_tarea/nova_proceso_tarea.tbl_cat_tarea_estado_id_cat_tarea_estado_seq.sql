/*
 ...
 Descripción: secuencia que incrementa de uno en uno el id_cat_tarea_estado de la tabla tbl_cat_tarea_estado, cada vez que se ingrese un registro o se ejecute una función o procedimiento
 Dependencias: tbl_cat_tarea_estado
 ERD: NO
 Nombre ERD: NO
 */
